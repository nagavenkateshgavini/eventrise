        ...
        <div className="container text-center text-md-left">
          <div className="row text-center text-md-left">
            <div className="col-md-3 col-lg-3 mx-auto mt-3 brand">
              ...
              <p className="text-left">
                ...
                events. The service charges a fee to event organizers in
                exchange for online ticketing services, unless the event is
                free.
              </p>
            </div>
          ...
          <div className="row">
            <div className="col">
              <small>
                {" "}
                Event Rise Copyright &copy; 2023 All Rights Reserved
              </small>
            </div>
          </div>
        </div>
